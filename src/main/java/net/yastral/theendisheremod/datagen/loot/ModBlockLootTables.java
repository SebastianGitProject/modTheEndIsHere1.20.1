package net.yastral.theendisheremod.datagen.loot;
...
import net.yastral.theendisheremod.datagen.ModBlockTagGenerator;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.SAPPHIRE_ORE.get(),block -> createCopperLikeOreDrops(ModBlocks.SAPPHIRE_ORE.get(), ModItems.Raw_Sapphire.get())); //shift + tasto sinistro su createRedstoneOreDrops()
        ...
        return createSilkTouchDispatchTable(pBlock, (LootPoolEntryContainer.Builder)
                this.applyExplosionDecay(pBlock,
                        LootItem.lootTableItem(item)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 10.0F)))//il numero di drop
