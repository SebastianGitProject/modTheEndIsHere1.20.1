package net.yastral.theendisheremod.sound;
...
public class ModSounds {
    ...
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, TheEndIsHereMod.MOD_ID);
    ...
    //public static final RegistryObject<SoundEvent> BAR_BRAWL = registerSoundEvents("bar_brawl"); //per i custom disc
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(TheEndIsHereMod.MOD_ID, name)));
    }
